    ...
    <div class="col-md-4">
        ...
        <div class="box box-success">
            ...
            <div class="box-body no-padding">
                ...
                <table class="table table-striped" id="kgCarneRinde<?php echo $i + 1;?>" style="font-size:1.2em;">
    ...
    <div class="col-md-4">
        ...
        <div class="box box-success">
            ...
            <div class="box-body no-padding">
                ...
                <table class="table table-striped" id="costoMargeKg<?php echo $i + 1;?>" style="font-size:1.2em;">
